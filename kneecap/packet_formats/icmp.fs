...
/// <summary>Packet scheme generator for ICMP.</summary>
...
*)
  ...
  let field_Type_sz = 8u
  let field_Code_sz = 8u
  let field_Checksum_sz = 16u
  let field_RestOfHeader_sz = 32u

  let header_sz =
    field_Type_sz +
    field_Code_sz +
    field_Checksum_sz +
    field_RestOfHeader_sz
  ...
  let field_Type_bv = ctxt.MkBVConst ("field_Type", field_Type_sz)
  let field_Code_bv = ctxt.MkBVConst ("field_Code", field_Code_sz)
  let field_Checksum_bv = ctxt.MkBVConst ("field_Checksum", field_Checksum_sz)
  let field_RestOfHeader_bv = ctxt.MkBVConst ("field_RestOfHeader", field_RestOfHeader_sz)
  ...
  override this.distinguished_constants =
    [ { name = "source_port";  write the field names here <--- 
